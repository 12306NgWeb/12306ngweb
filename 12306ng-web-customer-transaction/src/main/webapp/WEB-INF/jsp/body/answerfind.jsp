...
<div class="wrap">
    ...
    <!--find password by answer start-->
    <form action="">
    	<fieldset class="userinfors userlogin">
        	<legend>通过密保找回密码</legend>
			<ul>
				<li><label><em>*</em>密保问题：</label>我最喜欢的电影是哪部？</li>				
				<li class="pt20"><label><em>*</em>密保答案：</label><input type="text" name="userName" class="inputname" />
				<p>请输入您在设置密码保护时填写的密保答案</p></li>
			</ul>
        </fieldset>
