...
<div class="wrap">
    ...
    <form action="">
    	<fieldset class="userinfors userlogin">
        	<legend>重置密码</legend>
			<ul>
				<li><label><em>*</em>新密码：</label><input type="text" name="userName" class="inputname" />
				<p>请输入您需要重置的新密码</p></li>	
				<li><label><em>*</em>确认新密码：</label><input type="text" name="userName" class="inputname" />
				<p>请再次输入新密码</p></li>	
			</ul>
        </fieldset>
		<p class="tcenter"><input type="submit" name="submit" class="btnlogin mr20" value="提交" /><input type="submit" name="clear" class="btnreg" value="清空" /></p>
    </form>
