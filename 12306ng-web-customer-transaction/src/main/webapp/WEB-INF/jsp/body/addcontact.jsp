...
<div class="wrap">
	...
	<div class="myorder">
		...
		<div class="orderright fright myinfos">
			<h2>基本信息</h2>
			<ul>
				<li><label>用户名：</label><input type="text" name="addname" class="textname" /></li>
                <li><label>性别：</label><input type="radio" name="sex" class="radiosex" /><label style="width:auto;">男</label><input type="radio" name="sex" class="radiosex" /><label style="width:auto;">女</label></li>
				<li><label>出生日期：</label><input type="text" name="addname" class="textname" value="2013-03-03"/></li>
				...
				<li><label>证件号码：</label><input type="text" name="addname" class="textname" /></li>
			...
			<h2>联系方式</h2>
			<ul>
				<li><label>手机号：</label><input type="text" name="addname" class="textname" /></li>
				<li><label>固定电话：</label><input type="text" name="addname" class="textname" /></li>
				<li><label>电子邮件：</label><input type="text" name="addname" class="textname" /></li>
				<li><label>地址：</label><input type="text" name="addname" class="modifytxt" /></li>
				<li><label>邮编：</label><input type="text" name="addname" class="textname" /></li>
			</ul>
			<p class="pt10 tcenter topline"><a href="modifymyinfos.html"><input type="submit" name="add" class="btnadd mr10" value="保存" /></a></p>
		</div>
	</div>
