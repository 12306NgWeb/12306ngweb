...
<!--     <div class="header">
	...
	<script type="text/javascript"> 
		...
		function myReload(){
			document.getElementById("createCheckCode").src="${url}/servlet/SecurityCodeServlet?width=90&height=38&rnd"+Math.random();
		}
	</script>
    ...
    <form id="registerform" action="${url }/member/registersuccess" method="post">
	   <fieldset class="userinfors baseinfos">
           ...
           <ul>
               ...
               <p>请再次输入密码</p></li>
               <li><label><em>*</em>验证码：</label><input type="text" name="securitycode" class="inputname validate[required] text-input" style="width:200px;" />
               <img id="createCheckCode" src="${url}/servlet/SecurityCodeServlet?width=90&height=38" onclick="myReload()" style="vertical-align: bottom;margin: 0 0 0 10px;" />
               <p>看不清，<a class="blue" href="#" onClick="myReload()">换一张</a></p></li>
           </ul>
       </fieldset>
